...
import { employees, attendanceTrendData, departmentData, recentActivities } from '@/lib/data/sampleData';
...
export default function DashboardPage() {
  ...
  const attendanceRate = Math.round(employees.reduce((acc, curr) => acc + curr.attendance, 0) / totalEmployees);

  // Monochrome colors
  const COLORS = ['#0f172a', '#475569', '#94a3b8', '#cbd5e1']; // Slate 900, 700, 400, 300
